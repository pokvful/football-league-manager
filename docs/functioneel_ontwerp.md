...
| Als \[admin\] wil ik een knock-out tournament seizoen kunnen starten.															  | S      | Starten knockout tournament    |
...
| Als \[analist\] wil ik informatie over brackets voor een knock-out tournament           											| S      | Ophalen speelrondeinfo         |

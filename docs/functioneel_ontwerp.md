...
| Ophalen Brackets KO             | KO_Match, KO_Round, Match, Matchday, Round                                                               | Data-Analist en Admin | Het ophalen van brackets KO info die zich bevindt in ko_match, match, matchday, round, en ko_round tabel                                                                                                                                                                           |
...
| Start Nieuw Seizoen KO          | Season (R), Competition (R), Edition (I), Round (I), KO_Round (I), Matchday (I), KO_Match (I), Match (I) | Admin                 |                                                                                                                                                                                                                                                                                    |

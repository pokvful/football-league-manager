...
| 2    | Voer query uit voor het invoeren van een rode kaart als matchdata voor person id 11 in de 67ste minuut | ```EXEC PROC_ADD_MATCHDATA_RED_CARD @match_id = 0, @time = 67, @person_id = 11;``` | ![Invoeren matchdata result](images/test_results/invoeren-matchdata-resultaat.png) | ![Invoeren matchdata result](images/test_results/invoeren-matchdata-resultaat.png) | Geslaagd  |

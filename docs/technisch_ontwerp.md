...
- [Ontwerpkeuzes](#ontwerpkeuzes)
  ...
  - [EVENT id](#event-id)
  - [Events](#events)
    - [Losse tabel voor iedere event](#losse-tabel-voor-iedere-event)
    - [Één event-tabel, children voor complexere events](#één-event-tabel-children-voor-complexere-events)
    - [NoSQL](#nosql)
    - [Keuze](#keuze)
  - [ADD_NEW_EVENT_TYPE](#add_new_event_type)
  - [Moment van triggeren TRG_CHECK_PLAYER_COUNT](#moment-van-triggeren-trg_check_player_count)
    - [Alternatief](#alternatief)
  - [Match_type](#match_type)
    - [Losse tabellen](#losse-tabellen)
    - [Één tabel](#één-tabel)
...
- [Stored Procedures](#stored-procedures-1)
  - [Koppeling stored procedures met use cases](#koppeling-stored-procedures-met-use-cases)
  - [Koppeling stored procedures met views](#koppeling-stored-procedures-met-views)
...
| PROC_START_NEW_EDITION_KO                  | competition_name, season_name, list_of_clubs, start_date_competition                                | Starten van een nieuwe editie voor KO.                                                                              | N.V.T.                                                                                                                                                                                                                                                                                                                                              |
...
| Start nieuw seizoen KO         | PROC_START_NEW_EDITION_KO                  |

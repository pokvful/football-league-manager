...
| Test case ID | Test Case                                                                   | Test steps                                                                                                                                      | Pre-conditions                                                                                 | Test Data   | Post Conditions         | Expected Results                   | Actual Result | Status   |
|--------------|-----------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|-------------|-------------------------|------------------------------------|---------------|----------|
| TC-1         | TEST_CHK_VALID_MINUTE_IN_MATCH.[TEST_CHK_VALID_MINUTE_IN_MATCH_RED_CARD]    | 1.Open file test_CHK_VALID_MINUTE_IN_MATCH.sql<br>2.Run tSQLt.Run 'TEST_CHK_VALID_MINUTE_IN_MATCH.[TEST_CHK_VALID_MINUTE_IN_MATCH_RED_CARD]'    | 1.De constraint 'CHK_VALID_MINUTE_IN_MATCH_RED_CARD' is toegevoegd aan tabel dbo.RED_CARD      | (1, -10, 1) | Systeem geeft een error | Systeem voegd de gegevens niet toe |               | Geslaagd |
| TC-2         | TEST_CHK_VALID_MINUTE_IN_MATCH.[TEST_CHK_VALID_MINUTE_IN_MATCH_YELLOW_CARD] | 1.Open file test_CHK_VALID_MINUTE_IN_MATCH.sql<br>2.Run tSQLt.Run 'TEST_CHK_VALID_MINUTE_IN_MATCH.[TEST_CHK_VALID_MINUTE_IN_MATCH_YELLOW_CARD]' | 1.De constraint 'CHK_VALID_MINUTE_IN_MATCH_YELLOW_CARD is toegevoegd aan tabel dbo.YELLOW_CARD | (1, -10, 1) | Systeem geeft een error | Systeem voegd de gegevens niet toe |               | Geslaagd |
| TC-3         | TEST_CHK_VALID_MINUTE_IN_MATCH.[TEST_CHK_VALID_MINUTE_IN_MATCH_PASS]        | 1.Open file test_CHK_VALID_MINUTE_IN_MATCH.sql<br>2.Run tSQLt.Run 'TEST_CHK_VALID_MINUTE_IN_MATCH.[TEST_CHK_VALID_MINUTE_IN_MATCH_PASS]'        | 1.De constraint 'CHK_VALID_MINUTE_IN_MATCH_PASS' is toegevoegd aan de tabel dbo.PASS           | (1, -10, 1) | Systeem geeft een error | Systeem voegd de gegevens niet toe |               | Geslaagd |
| TC-4         | TEST_CHK_VALID_MINUTE_IN_MATCH.[TEST_CHK_VALID_MINUTE_IN_MATCH_GOAL]        | 1.Open file test_CHK_VALID_MINUTE_IN_MATCH.sql<br>2.Run tSQLt.Run 'TEST_CHK_VALID_MINUTE_IN_MATCH.[TEST_CHK_VALID_MINUTE_IN_MATCH_GOAL]'        | 1.De constraint 'CHK_VALID_MINUTE_IN_MATCH_SHOT' is toegevoegd aan de tabel dbo.SHOT           | (1, -10, 1) | Systeem geeft een error | Systeem voegd de gegevens niet toe |               | Geslaagd |
| TC-5         |                                                                             |                                                                                                                                                 |                                                                                                |             |                         |                                    |               |          |

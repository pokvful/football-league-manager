...
BEGIN
	...
	INSERT INTO MATCH (MATCH_ID, SEASON_NAME, COMPETITION_NAME, START_DATE, MATCH_DAY, HOME_CLUB_NAME, OUT_CLUB_NAME, STADIUM_NAME, REFEREE_PERSON_ID, BRACKET_RIGHT, BRACKET_LEFT, MATCH_TYPE, BALL_POSSESSION_HOME, BALL_POSSESSION_OUT, SPECTATORS)
	VALUES (1, '20/21', 'comp', GETDATE(), GETDATE(), 'home', 'out', 'aStadium', 420, 1, 1, 1, 20, 70, 100020)
	...
	INSERT INTO MATCH (MATCH_ID, SEASON_NAME, COMPETITION_NAME, START_DATE, MATCH_DAY, HOME_CLUB_NAME, OUT_CLUB_NAME, STADIUM_NAME, REFEREE_PERSON_ID, BRACKET_RIGHT, BRACKET_LEFT, MATCH_TYPE, BALL_POSSESSION_HOME, BALL_POSSESSION_OUT, SPECTATORS)
	VALUES (2, '20/21', 'comp2', GETDATE(), GETDATE(), 'home', 'out', 'aStadium', 420, 1, 1, 1, 20, 70, 100020)
...
BEGIN
	...
	(1,	'20/21',	'comp',		GETDATE(),	GETDATE(),	'home',	'out',	'aStadium',	420,	1, 1, 1, 20.00,	70.00,	100020,	1,	1,	1,	2,	1,	1,	1,	1,  1),
	(2,	'20/21',	'comp2',	GETDATE(),	GETDATE(),	'home',	'out',	'aStadium',	420,	1, 1, 1, 20.00,	70.00,	100020,	1,	1,	1,	2,	1,	1,	1,	1,	1)

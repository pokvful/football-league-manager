...
BEGIN
	...
	EXEC [tSQLt].[ApplyTrigger] @tablename = 'dbo.SUBSTITUTE',
		 @triggername = 'TRG_SUBSTITUTE_IN_ONLY_FOR_PLAYER_PLAYED_IN_MATCH'
	EXEC [tSQLt].[ApplyTrigger] @tablename = 'dbo.SUBSTITUTE',
		 @triggername = 'TRG_SUBSTITUTE_OUT_ONLY_FOR_PLAYER_PLAYED_IN_MATCH'
END
GO
...
CREATE OR ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[test pass when person id is correct but match id doesnt exist, should fail]
AS
BEGIN
	--Act
	EXEC [tSQLt].[ExpectException] 'Player didnt play in the assigned match'
...
CREATE OR ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[test SHOT when person id is correct but match id doesnt exist, should fail]
AS
BEGIN
	--Act
	EXEC [tSQLt].[ExpectException] 'Player didnt play in the assigned match'
...
CREATE OR ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[test FOUL when person id is correct but match id doesnt exist, should fail]
AS
BEGIN
	--Act
	EXEC [tSQLt].[ExpectException] 'Player didnt play in the assigned match'
...
CREATE OR ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[test CORNER when person id is correct but match id doesnt exist, should fail]
AS
BEGIN
	--Act
	EXEC [tSQLt].[ExpectException] 'Player didnt play in the assigned match'
...
CREATE OR ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[test CSUBSTITUTE_IN when person id is correct but match id doesnt exist, should fail]
AS
BEGIN
	--Act
	EXEC [tSQLt].[ExpectException] 'Player didnt play in the assigned match'

...
CREATE
OR
ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[test pass when person id is correct but match id doesnt exist, should fail]
	AS
BEGIN
--Act
EXEC [tSQLt].[ExpectException] 'Player didnt play in the assigned match'
...
CREATE
OR
ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[Test goal only for one player played in match, should succeed]
	AS
BEGIN
--Act
EXEC [tSQLt].[ExpectNoException]
...
CREATE
OR
ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[Test goal only for one player played in match, should fail]
	AS
BEGIN
--Act
EXEC [tSQLt].[ExpectException] 'Player didnt play in the assigned match'
...
CREATE
OR
ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[Test goal for more then one player played in match where both played in match, should succeed]
	AS
BEGIN
	--Assemble
...
CREATE
OR
ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[test SHOT when person id is correct but match id doesnt exist, should fail]
	AS
BEGIN
--Act
EXEC [tSQLt].[ExpectException] 'Player didnt play in the assigned match'
...
CREATE
OR
ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[Test FOUL only for one player played in match, should succeed]
	AS
BEGIN
--Act
EXEC [tSQLt].[ExpectNoException]
...
CREATE
OR
ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[Test FOUL only for one player played in match, should fail]
	AS
BEGIN
--Act
EXEC [tSQLt].[ExpectException] 'Player didnt play in the assigned match'
...
CREATE
OR
ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[Test FOUL for more then one player played in match where both played in match, should succeed]
	AS
BEGIN
--Act
EXEC [tSQLt].[ExpectNoException]
...
CREATE
OR
ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[Test FOUL for more then one player played in match where one doesnt exist, should failed]
	AS
BEGIN
--Act
EXEC [tSQLt].[ExpectException] 'Player didnt play in the assigned match'
...
CREATE
OR
ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[test FOUL when person id is correct but match id doesnt exist, should fail]
	AS
BEGIN
--Act
EXEC [tSQLt].[ExpectException] 'Player didnt play in the assigned match'
...
CREATE
OR
ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[test CORNER when person id is correct but match id doesnt exist, should fail]
	AS
BEGIN
--Act
EXEC [tSQLt].[ExpectException] 'Player didnt play in the assigned match'
...
CREATE
OR
ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[Test SUBSTITUTE_IN only for one player played in match and is reserve, should succeed]
	AS
BEGIN
--Act
EXEC [tSQLt].[ExpectNoException]
...
CREATE
OR
ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[Test SUBSTITUTE_IN only for one player played in match and is reserve, should fail]
	AS
BEGIN
--Act
EXEC [tSQLt].[ExpectException] 'Player didnt play in the assigned match'
...
CREATE
OR
ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[Test SUBSTITUTE_IN for more then one player played in match where one doesnt exist, should succeed]
	AS
BEGIN
--Act
EXEC [tSQLt].[ExpectNoException]
...
CREATE
OR
ALTER PROCEDURE TRG_CHECK_ALL_EVENTS.[test CSUBSTITUTE_IN when person id is correct but match id doesnt exist, should fail]
	AS
BEGIN
--Act
EXEC [tSQLt].[ExpectException] 'Player didnt play in the assigned match'

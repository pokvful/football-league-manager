...
BEGIN
	...
	EXEC TSQLT.ASSERTEMPTYTABLE 'dbo.POSITION'
END
GO
EXEC TSQLT.RUN 'TEST_TRG_CHECK_CORRECT_PLAYERS_IN_MATCH_FOR_POSITION.[test trigger player not from a club]'
GO
CREATE OR ALTER PROCEDURE TEST_TRG_CHECK_CORRECT_PLAYERS_IN_MATCH_FOR_POSITION.[test trigger player not from right club]
AS
BEGIN
	INSERT INTO PLAYER (PERSON_ID, CLUB_NAME)
	VALUES (22, 'verkeerde')
...
END
GO
EXEC TSQLT.RUN 'TEST_TRG_CHECK_CORRECT_PLAYERS_IN_MATCH_FOR_POSITION.[test trigger player not from right club]'